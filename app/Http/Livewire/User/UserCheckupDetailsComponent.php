...
class UserCheckupDetailsComponent extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.user.user-checkup-details-component',['appointment'=>$appointment])->layout('layouts.base');
    }
}
