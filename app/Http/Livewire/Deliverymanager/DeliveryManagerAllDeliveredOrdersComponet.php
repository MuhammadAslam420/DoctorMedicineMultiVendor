...
class DeliveryManagerAllDeliveredOrdersComponet extends Component
{
    use WithPagination;
...
public function orderConfirmationMail($order)
{
    ...
    public function render()
    {
        ...
        return view('livewire.deliverymanager.delivery-manager-all-delivered-orders-componet',['orders'=>$orders,
