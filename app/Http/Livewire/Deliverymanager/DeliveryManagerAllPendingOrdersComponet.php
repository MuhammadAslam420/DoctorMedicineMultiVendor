...
class DeliveryManagerAllPendingOrdersComponet extends Component
{
    use WithPagination;
...
public function orderConfirmationMail($order)
{
    ...
    public function render()
    {
        ...
        return view('livewire.deliverymanager.delivery-manager-all-pending-orders-componet',['orders'=>$orders,
