...
class DeliveryManagerAllDispatchOrdersComponet extends Component
{
    use WithPagination;
...
public function orderConfirmationMail($order)
{
    ...
    public function render()
    {
        ...
        return view('livewire.deliverymanager.delivery-manager-all-dispatch-orders-componet',['orders'=>$orders,
