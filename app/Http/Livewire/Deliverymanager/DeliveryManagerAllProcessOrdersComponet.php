...
class DeliveryManagerAllProcessOrdersComponet extends Component
{
    use WithPagination;
...
public function orderConfirmationMail($order)
{
    ...
    public function render()
    {
        ...
        return view('livewire.deliverymanager.delivery-manager-all-process-orders-componet',['orders'=>$orders,
