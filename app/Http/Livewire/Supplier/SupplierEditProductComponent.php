...
use Auth;
class SupplierEditProductComponent extends Component
{
    use WithFileUploads;
    public $name;
    public $user_id;
    ...
    public function render()
    {
        ...
        return view('livewire.supplier.supplier-edit-product-component',['categories'=>$categories])->layout('layouts.supplier.base');
    }
}
