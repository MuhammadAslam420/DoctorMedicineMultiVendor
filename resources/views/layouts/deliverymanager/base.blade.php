...
<head>
  ...
  <title>UAE Medicine - DeliveryManager Dashboard</title>
  <!-- General CSS Files -->
  ...
  <div id="app">
    <div class="main-wrapper main-wrapper-1">
      ...
      <nav class="navbar navbar-expand-lg main-navbar sticky">
        ...
        @php
        $profile=DB::table('managers')->where('user_id','=',Auth::user()->id)->first();
        @endphp
        @if($profile)
          <li class="dropdown"><a href="#" data-toggle="dropdown"
            ...
            <div class="dropdown-menu dropdown-menu-right pullDown">
              ...
              <a href="{{route('deliverymanager.profile')}}" class="dropdown-item has-icon"> <i class="fa fa-user"></i> Profile
              </a>
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown"
            ...
            <div class="dropdown-menu dropdown-menu-right pullDown">
              <div class="dropdown-title">Hello </div>
              <a href="{{route('deliveryboy.profile')}}" class="dropdown-item has-icon"> <i class="fa fa-user"></i> Profile
              </a>
              <a href="#" class="dropdown-item has-icon"> <i class="fa fa-lock"></i> Change Password
              </a>
        ...
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="/"> <img alt="image" src="{{asset('assets/admin2/img/logo.png')}}" class="header-logo" /> <span
                class="logo-name" style="font-size:9px;">UAE Medicine DeliveryManager</span>
            </a>
          </div>
          <ul class="sidebar-menu">
            <li class="menu-header">Main</li>
            <li class="dropdown ">
              <a href="{{route('deliverymanager.dashboard')}}" class="nav-link"><i data-feather="monitor"></i><span>Dashboard</span></a>
            </li>
            <li class="dropdown ">
              <a href="{{route('deliverymanager.allorders')}}" class="nav-link"><i data-feather="shopping-cart"></i><span>All Orders</span></a>
            </li>
          </ul>
        </aside>
      </div>
