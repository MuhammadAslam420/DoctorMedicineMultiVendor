            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h4>Edit / View / Approved Product</h4>
                  <div class="row">
                   
                   <div class="col-12">
                       <a href="{{route('admin.approvalproduct')}}" class="btn btn-success pull-right">Supplier's Products</a>
                ...
                <form action="" class="form-horizontal" enctype="multipart/form-data" wire:submit.prevent="updateProduct">
                               ...
                               <div class="form-group">
                                   <label for="" class="col-md-4 control-label">Approval To Sell</label>
                                   <div class="col-md-12">
                                       <select name="" id="" class="form-control" wire:model="approval">
                                           <option value="0">No</option>
                                           <option value="1">Yes</option>
                                       </select>
                                   </div>
