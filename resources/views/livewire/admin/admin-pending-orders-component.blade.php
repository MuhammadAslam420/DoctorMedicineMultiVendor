                            ...
                            @foreach($pendingorders as $order)
                              <tr>
                                  ...
                                  <div class="dropdown">
                                      ...
                                      <li class="text-center"><a href="#" wire:click.prevent="updateOrderStatus({{$order->id}},'approved')">Approved</a></li>
                                  ...
                                  <td><a href="{{route('admin.orderdetails',['order_id'=>$order->order_id])}}" class='btn btn-primary'>Detail</a></td>
                              </tr>
                              @endforeach
                          </tbody>
