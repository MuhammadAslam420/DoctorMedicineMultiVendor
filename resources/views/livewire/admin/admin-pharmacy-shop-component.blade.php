                                    ...
                                    @foreach($products as $product)
                                        ...
                                        <tr>
                                            ...
                                            <td class="d-flex inline-flex">
                                                ...
                                                <a href="#" class="btn btn-primary" style="height:40px;" wire:click.prevent="store({{$product->id}},'{{$product->name}}',{{$product->regular_price}})"><i class="fa fa-shopping-cart"></i></a>                                           
                                            </td>
                                        </tr>
