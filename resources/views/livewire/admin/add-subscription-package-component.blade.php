            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Add Subscription Packages</h4>
                    ...
                    <div class="card-body p-0">
                        <div class="ml-5 mr-5 justify-content-center">
                            <form action="" wire:submit.prevent="addNewPackage">
                                <div class=" row">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-12" wire:ignore>
                                        <div class="form-group">
                                            ...
                                            <textarea class="tinymce-editor" name="description" id="description" wire:model="description"></textarea>
