            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h4>All Other Supplier/3rd Party Products</h4>
                  <div class="row">
                        ...
                        <thead>
                         ...
                         <thead>
                             ...
                             <tr>
                                 ...
                                 <td class="p-2 text-center">Approved</td>
                                 @else
                                 <td class="p-2 text-center">Approval Pending</td>
                                 @endif
                                 ...
                                 <a href="{{route('admin.editsupplierproduct',['product_slug'=>$product->slug])}}" style="text-decoration:none; font-weight:900;"><i class="fa fa-check  text-info"></i>/<i class="fa fa-edit  text-info"></i>/<i class="fa fa-eye  text-info"></i></a>
                                 <a href="#" onclick="confirm('Are You Sure, You want to delete the Product!.') || event.stopImmediatePropagation()" wire:click.prevent="deleteProduct({{$product->id}})" ><i class= "fa fa-times text-danger"></i></a></td>
                             </tr>
                             @endforeach
