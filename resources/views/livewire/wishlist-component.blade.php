                ...
                <div class="table-responsive shopping-summery">
                    <table class="table table-wishlist p-1">
                        ...
                        <tbody>
                            ...
                            <tr class="pt-30">
                                <td class="image product-thumbnail pt-40"><img src="{{asset('images/product')}}/{{$item->model->image}}" alt="{{$item->model->name}}" /></td>
                                <td class="product-des product-name">
                                    <h6><a class="product-name mb-10" href="{{route('product.details',['slug'=>$item->model->slug])}}">{{$item->model->name}}</a></h6>
                                </td>
                                <td class="price" data-title="Price">
                                    <h3 class="text-brand">${{$item->model->regular_price}}</h3>
                                </td>
