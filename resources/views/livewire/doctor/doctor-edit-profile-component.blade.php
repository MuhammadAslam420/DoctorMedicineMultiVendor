                ...
                <div class="card-body p-0">
                  ...
                  <form action="" class="form-horizontal" enctype="multipart/form-data" wire:submit.prevent="updateprofile">
                               ...
                               <div class="form-group">
                                   <label for="" class="col-md-4 control-label">Professional Name</label>
                                   <div class="col-md-12">
                                       <input type="text" class="form-control input-md" placeholder="Professional Name" wire:model="firstname" wire:keyup="generateslug"/>
                               ...
                               <div class="form-group">
                                   <label for="" class="col-md-4 control-label">Hospital Where Practice</label>
                                   <div class="col-md-12">
                                       <select  class="form-control" wire:model="hospital_id">
                                           <option value="">Select hospital</option>
                                           @foreach($hospitals as $hospital)
                                           <option value="{{$hospital->id}}">{{$hospital->hospital}}, {{$hospital->city}}, {{$hospital->country}}</option>
                                           @endforeach
                                           
                                       </select>
                                       @error('hospital_id')<p class="text-danger">{{$message}}</p>@enderror
                               ...
                               <div class="form-group">
                                   <label for="" class="col-md-4 control-label">Specialist</label>
                                   <div class="col-md-12">
                                   <select class="specialist form-control" name="specialists[]" multiple="multiple"   wire:model="specialist">
                               ...
                               <div class="form-group">
                                   ...
                                   <div class="col-md-12">
                                       <input type="file" class="input-file" multiple  wire:model="newoimages"/>
                                       @error('newoimages')<p class="text-danger">{{$message}}</p>@enderror
                                       @if($newoimages)
                                       @foreach($newoimages as $other)
...
<script>
    $(function(){
        ...
        tinymce.init({
            ...
            setup:function(editor){
                editor.on('Change',function(e){
                    tinyMCE.triggerSave();
                     var d_data=$('#degree').val();
                     @this.set('degree',d_data);
                });
            }
        });
    ...
    $(document).ready(function(){
        ...
        $('.specialist').on('change',function(e){
            var data=$('.specialist').select2("val");
            @this.set('specialist',data);
