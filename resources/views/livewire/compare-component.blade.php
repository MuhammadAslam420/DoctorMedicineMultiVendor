                        ...
                        <tbody>
                            <tr class="pr_image">
                                <td class="text-muted font-sm fw-600 font-heading mw-200">Preview</td>
                                 ...
                                 <td class="row_img"><img src="{{ asset('images/product') }}/{{ $item->model->image }}" alt="compare-img" /></td>
                            ...
                            <tr class="pr_title">
                                ...
                                <td class="product_name">
                                    <h6><a class="text-success" href="{{ route('product.details',['slug'=>$item->model->slug]) }}" class="text-heading">{{ $item->name }}</a></h6>
                                </td>
                            ...
                            <tr class="pr_price">
                                ...
                                <td class="product_price">
                                    <h4 class="price text-brand">{{ $item->model->regular_price }}</h4>
                                </td>
                                @endforeach
                            ...
                            <tr class="pr_add_to_cart">
                              ...
                              @foreach(Cart::instance('compare')->content() as  $item)
                              <td class="row_btn">
                                <button class="btn btn-sm" wire:click.prevent="store({{$item->id}},'{{$item->name}}',{{$item->model->regular_price}})"><i class="fa fa-shopping-bag mr-5"></i>Add to cart</button>
                            </td>
                              @endforeach
                            </tr>
