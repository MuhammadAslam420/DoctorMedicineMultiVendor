    ...
    <div class="page-header breadcrumb-wrap">
        <div class="container">
            <div class="breadcrumb">
                ...
                <i class="fa fa-angle-right"></i > Pages <i class="fa fa-angle-right"></i > Contact
            </div>
        </div>
    </div>
                    ...
                    <section class="mb-50">
                        <div class="row mb-60">
                            <div class="col-md-4 mb-4 mb-md-0">
                                ...
                                <abbr title="Phone">Phone:</abbr> {{ $setting->phone }}<br />
                                <abbr title="Email">Email: </abbr>{{ $setting->email }}<br />
                                <a class="btn btn-sm font-weight-bold text-white mt-20 border-radius-5 btn-shadow-brand hover-up" href="/"><i class="fa fa-marker mr-5"></i>Shop</a>
                            </div>
                            <div class="col-md-4 mb-4 mb-md-0">
                                <h4 class="mb-15 text-brand">Office</h4>
                                {{ $setting->address }}<br />

                                <abbr title="Phone">Phone:</abbr> {{ $setting->phone2 }}<br />
                                <abbr title="Email">Email: </abbr>{{ $setting->email }}<br />
                                <a class="btn btn-sm font-weight-bold text-white mt-20 border-radius-5 btn-shadow-brand hover-up" href="/"><i class="fa fa-marker mr-5"></i>Shop</a>
                            </div>
                            <div class="col-md-4">
