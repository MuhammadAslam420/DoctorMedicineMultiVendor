        ...
        <div class="row flex-row-reverse">
                ...
                <div class="product-list mb-50">
                    ...
                    <div class="product-cart-wrap">
                        ...
                        <div class="product-content-wrap">
                            ...
                            <h2><a href="{{route('product.details',['slug'=>$product->id])}}">{{$product->name}}</a></h2>
                            ...
                            <div class="mt-30 d-flex align-items-center">
                                <a class="add btn" href="#" wire:click.prevent="store({{$product->id}},'{{$product->name}}',{{$product->regular_price}})"><i class="fa fa-shopping-bag mr-5"></i>Add </a>
                                <a href="#" class="add-wishlish btn text-light ml-30  " wire:click.prevent="addToCompare({{$product->id}},'{{$product->name}}',{{$product->price}})"><i
            ...
            <div class="col-lg-1-5 primary-sidebar " wire:ignore.self>
                ...
                <div class="sidebar-widget product-sidebar mb-30 p-30 bg-grey border-radius-10">
                    ...
                    <div class="single-post clearfix">
                        ...
                        <div class="content pt-10">
                            ...
                            <p class="price mb-0 mt-5">{{ $prod->regular_price }}</p>
                ...
                <div class="banner-img wow fadeIn mb-lg-0 animated d-lg-block d-none">
                    <img src="{{ asset('images/banner/12.jpg')}}" />
