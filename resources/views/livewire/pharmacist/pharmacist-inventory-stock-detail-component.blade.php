                                      ...
                                      @php
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-success">
                                                @php
                                                $inventory=DB::table('pharmacy_order_items')->where('product_id',$order->id)->sum('quantity');
                                                @endphp
                                                {{$inventory}}
                                            </td>
                                            <td class="text-warning">{{$order->quantity - $inventory}}</td>
                                            <td class="text-warning">{{$order->price}}</td>
                                            <td class="text-warning">
                                            @php
                                                $amout=DB::table('pharmacy_order_items')->where('product_id',$order->id)->select(DB::raw('sum((price)*(quantity))as total'))->get()[0]->total;
                                                @endphp
                                                {{$amout}}</td>
                                                <td class="text-warning">
