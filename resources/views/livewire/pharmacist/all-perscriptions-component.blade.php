                    ...
                    @endif
                                 ...
                                 @php
                                  ...
                                  @endphp
                                     ...
                                     <tr>
                                         <td>{{$i++}}</td>
                                            ...
                                            <a href="{{asset('images/perscription')}}/{{$image}}"  data-rel="lightcase:myCollection">
                                                <img src="{{asset('images/perscription')}}/{{$image}}" style="width:60px;height60px;" class="p-1"   alt="{{$perscription->firstname}}">
                                            </a>
                                            @endif
                                            @endforeach
                                             </td>
                                             ...
                                             <td>{{$perscription->line1}} {{$perscription->line2}}</td>
                                                ...
                                                <td class="text-danger">{{$perscription->status}}</td>
                                                <td>
                                                <div class="dropdown">
                                     ...
                                     <li class="text-center"><a href="#" wire:click.prevent="updatePerscriptionStatus({{$perscription->id}},'dispatch')">Dispatch</a></li>
                                       <li class="text-center"><a href="#" wire:click.prevent="updatePerscriptionStatus({{$perscription->id}},'delivered')">Delivered</a></li>
                                       <li class="text-center"><a href="#" wire:click.prevent="updatePerscriptionStatus({{$perscription->id}},'canceled')">Canceled</a></li>
                                     </ul>
                                    </div>
                                                </td>
                                     </tr>
