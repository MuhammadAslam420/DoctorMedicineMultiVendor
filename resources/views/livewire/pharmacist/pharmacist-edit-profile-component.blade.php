            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-body p-0">
                  ...
                  <form action="" class="form-horizontal" enctype="multipart/form-data" wire:submit.prevent="updatepharmacist">
                               ...
                               <div class="form-group">
                                   <label for="" class="col-md-4 control-label">pharmacy Name</label>
                                   <div class="col-md-12" wire:ignore>
                                   <input type="text" class="form-control input-md" placeholder="Pharmacy Name" wire:model="pharmacy_name">                                       @error('about_self')<p class="text-danger">{{$message}}</p>@enderror
                               ...
                               <div class="form-group">
                                   ...
                                   <div class="col-md-12" wire:ignore>
                                   <input type="text" class="form-control input-md" placeholder="Pharmacy License No" wire:model="registration_no">                                       @error('experience')<p class="text-danger">{{$message}}</p>@enderror
                                       
                                   </div>
                               </div>
                               <div class="form-group">
                                   <label for="" class="col-md-4 control-label">pharmacy Address</label>
                                   <div class="col-md-12" wire:ignore>
                                   <input type="text" class="form-control input-md" placeholder="Address Line1" wire:model="pharmacy_address">                                       @error('degree')<p class="text-danger">{{$message}}</p>@enderror
                               ...
                               <div class="form-group">
                                   <label for="" class="col-md-4 control-label">ZipCode</label>
                                   <div class="col-md-12">
                                   <input type="text" class="form-control input-md" placeholder="zipcode" wire:model="zipcode"/>
                               ...
                               <div class="form-group">
                                   ...
                                   <div class="col-md-12">
                                   <input type="text" class="form-control input-md" placeholder="Enter Embeded map link" wire:model="map"/>
                               ...
                               <div class="col-md-4">
                                ...
                                @elseif($image)
                                <img src="{{asset('images/pharmacist')}}/{{$image}}" width=100% >
                                @else
