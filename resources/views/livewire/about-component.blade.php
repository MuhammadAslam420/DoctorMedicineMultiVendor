    ...
    <div class="page-header breadcrumb-wrap">
        <div class="container">
            <div class="breadcrumb">
                ...
                <i class="fa fa-angle-right"></i> Pages <i class="fa fa-angle-right"></i> About us
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-xl-10 col-lg-12 m-auto">
                    <section class="row align-items-center mb-50">
                        ...
                        <div class="col-lg-6">
                            <div class="pl-25">
                                <h2 class="mb-30">Welcome to MedicinePk</h2>
                                        ...
                                        <div class="team-card">
                                            ...
                                            <div class="content text-center">
                                                ...
                                                <div class="social-network mt-20">
                                                    <a href="#"><img src="{{asset('assets/images/icon-facebook-brand.svg')}}" alt="" /></a>
                                                    <a href="#"><img src="{{asset('assets/images/icon-twitter-brand.svg')}}" alt="" /></a>
                                                    <a href="#"><img src="{{asset('assets/images/icon-instagram-brand.svg')}}" alt="" /></a>
                                                    <a href="#"><img src="{{asset('assets/images/icon-youtube-brand.svg')}}" alt="" /></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
