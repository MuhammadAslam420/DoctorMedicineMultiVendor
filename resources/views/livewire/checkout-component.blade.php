            ...
            <div class="col-lg-7">
                ...
                <div class="row">
                    ...
                    <div class="custome-checkbox">
                        <input name="different-add" id="different-add" value="1" type="checkbox" wire:model="ship_to_different" style="width:22px;">
                ...
                <div class="payment ml-30">
                    ...
                    <div class="payment_option">
                        ...
                        <div class="custome-radio">
                            <input type="radio" name="payment-method" id="payment-method-visa" value="cod" wire:model="paymentmode" style="width:22px;">
                    ...
                    <div class="payment-logo d-flex">
                        ...
                        <img src="{{ asset('assets/images/payment-zapper.svg') }}" alt="">
                    </div>
