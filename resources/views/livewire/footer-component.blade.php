...
@livewire('subscription-component')
    <section class="featured section-padding"  style="background-color:#ffffff;">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-1-5 col-md-4 col-12 col-sm-6 d-xl-none">
                    <div class="banner-left-icon d-flex align-items-center wow animate__animated animate__fadeInUp" data-wow-delay=".5s">
                        <div class="banner-icon">
                            <img src="{{ asset('images/icon-6.svg') }}" alt="" />
                        </div>
                        <div class="banner-text">
            ...
            <div class="row">
                    ...
                    <div class="product-list-small animated animated">
                        ...
                        <article class="row align-items-center hover-up">
                            <figure class="col-md-4 mb-0">
                                <a href="{{ route('product.details',['slug'=>$item->product->slug]) }}"><img src="{{asset('images/product')}}/{{ $item->product->image}}" alt="" /></a>
                            </figure>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 mb-md-0 wow animate__animated animate__fadeInUp" data-wow-delay=".1s">
                    ...
                    <div class="product-list-small animated animated">
                        ...
                        <article class="row align-items-center hover-up">
                            <figure class="col-md-4 mb-0">
                                <a href="{{ route('product.details',['slug'=>$trending->slug]) }}"><img src="{{asset('images/product')}}/{{ $trending->image}}" alt="" /></a>
                            </figure>
                            <div class="col-md-8 mb-0">
                                <h6>
                                    <a href="{{ route('product.details',['slug'=>$trending->slug]) }}">{{ $trending->name }}</a>
                                </h6>
                                <div class="product-price">

                                    <span>{{ $trending->regular_price }}</span>
                                </div>
                            </div>
                        </article>
                        @endforeach
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 mb-sm-5 mb-md-0 d-none d-lg-block wow animate__animated animate__fadeInUp" data-wow-delay=".2s">
                    ...
                    <div class="product-list-small animated animated">
                        ...
                        <article class="row align-items-center hover-up">
                            <figure class="col-md-4 mb-0">
                                <a href=" {{ route('product.details',['slug'=>$recent->slug]) }} "><img src="{{asset('images/product')}}/{{ $recent->image}}" alt="" /></a>
                            </figure>
                            <div class="col-md-8 mb-0">
                                <h6>
                                    <a href="{{ route('product.details',['slug'=>$recent->slug]) }}">{{ $recent->name }}</a>
                                </h6>

                                <div class="product-price">

                                    <span>{{ $recent->regular_price }}</span>
                                </div>
                            </div>
                        </article>
    ...
    <!--End 4 columns-->
    <section class="section-padding footer-mid" style="background-color:#ffffff;">
                ...
                <div class="col">
                    <div class="widget-about font-md mb-md-3 mb-lg-3 mb-xl-0 wow animate__animated animate__fadeInUp" data-wow-delay="0">
                        <div class="logo mb-30">
                            ...
                            <a href="/" class="mb-15"><img src="{{asset('images/product')}}/{{ $setting->footer_logo }}" alt="logo" /></a>
                            <p class="font-lg text-heading">{{ $setting->name }}</p>
                            @else
                            <a href="/" class="mb-15"><img src="{{asset('images/logo.svg')}}" alt="logo" /></a>
                            <p class="font-lg text-heading">My Medicine Pharmacy.pk</p>
                            @endif
                            @else
                            <a href="/" class="mb-15"><img src="{{asset('images/logo.svg')}}" alt="logo" /></a>
                            <p class="font-lg text-heading">My Medicine Pharmacy.pk</p>
    ...
    <div class="container pb-30 wow animate__animated animate__fadeInUp" data-wow-delay="0"  style="background-color:#ffffff;">
        <div class="row align-items-center">
            ...
            <div class="col-xl-4 col-lg-6 text-center d-none d-xl-block">
                <div class="hotline d-lg-inline-flex mr-30">
                    ...
                    @if ($setting)
                    @if ($setting->hotline)
                    <p>{{ $setting->hotline }}<span>Working {{ $setting->time }}</span></p>
                    @else
                ...
                <div class="hotline d-lg-inline-flex">
                    ...
                    @if ($setting)
                    @if ($setting->hotline)
                    <p>{{ $setting->hotline }}<span>24/7 Support Center</span></p>
                    @else
